...
def calculate_credit_card_points(credit_card_name, amount_spent_dollars, hotel_corporation=None, travel_portal=None) -> tuple[int, int]:
    try:
    ...
    if travel_portal and credit_card.travel_portal and credit_card.travel_portal.name == travel_portal:
